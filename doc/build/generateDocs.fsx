...
let buildDir = "../../source/IrcDotNet/bin/Debug/"
...
let buildAllDocumentation outDocDir website_root =
    ...
    let projInfo =
        [ "root", website_root
          ...
          "project-author", "Alex Regueiro and Christian Stewart"
    ...
    let copyDocContentFiles () =
      ...
      CopyRecursive "../content/content" (outDocDir @@ "html" @@ "content") true |> Log "Copying file: "
    ...
    let processDocumentationFiles(outputKind) =
      ...
      processDirectory template "../content" outDir
    ...
    let buildReference () =
        ...
        MetadataFormat.Generate
           (binaries, Path.GetFullPath outDir, layoutRoots,
            parameters = projInfo,
            libDirs = [ Path.GetFullPath ("../../source/IrcDotNet/bin/Debug/net45") ],
